...
DOMAIN = "comfortzone"
# --- Use ONLY RawData endpoint for reading status ---
...
# Default low temp value used to signify "OFF" mode for the climate entity
...
CLEAR_TEXT_NAMES = {
    ...
    "HW_EXTRA_MODE": "Extra hot water mode", # Used by Switch state reading
    # States / Alarms / Valves for HVAC Action
...
# These should map the desired binary_sensor suffix to the ClearTextName to read
BINARY_SENSOR_MAP = {
    "filter_alarm": CLEAR_TEXT_NAMES["FILTER_ALARM"],
    "main_alarm": CLEAR_TEXT_NAMES["ALARM_TEXT"], # Active if text is not empty
